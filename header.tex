...
\tcbuselibrary{theorems,skins}%tcboxmathを使うため
...
\newcommand{\Reidai}[1]{\fcolorbox{green}{green!20!white}{\ 例題#1\ }\vspace{.5\zw}\\}
\newcommand{\Toi}[1]{\fcolorbox{red}{pink!20!white}{\ 問#1\ }\vspace{.5\zw}\\}
\newcommand{\Setumatu}[1]{\fcolorbox{black}{gray!20!white}{\ 節末#1\ }\quad{}}
\newcommand{\Libry}[1]{\fcolorbox{orange}{orange!20!white}{\ #1\ }\ \textcolor{orange}{\small 解き終わったらスクリーンショットを撮ってLibryに登録！}\vspace{.5\zw}\\}
